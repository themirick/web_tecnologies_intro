...
файл 1.js (его тоже необходимо создать рядом с html-файлом). 
...
const temperature = parseInt(prompt("Input temperature in Celsius"))

alert(`The temperature in Celsius: ${temperature}C and in Fahrenheit: ${CelsiusToFahrenheit(temperature).toFixed(1)}F`)
